...
func (fake *DistillWriter) WriteCallCount() int {
	fake.writeMutex.RLock()
	defer fake.writeMutex.RUnlock()
	return len(fake.writeArgsForCall)
}

func (fake *DistillWriter) WriteCalls(stub func(context.Context, string, string) error) {
	fake.writeMutex.Lock()
	defer fake.writeMutex.Unlock()
	fake.WriteStub = stub
}

func (fake *DistillWriter) WriteArgsForCall(i int) (context.Context, string, string) {
	fake.writeMutex.RLock()
	defer fake.writeMutex.RUnlock()
...
func (fake *DistillWriter) WriteReturnsOnCall(i int, result1 error) {
	fake.writeMutex.Lock()
	defer fake.writeMutex.Unlock()
	fake.WriteStub = nil
...
func (fake *DistillWriter) Invocations() map[string][][]interface{} {
...
var _ distill.Writer = new(DistillWriter)
