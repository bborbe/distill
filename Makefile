...
LDFLAGS := -X github.com/bborbe/distill/pkg/cli.version=$(VERSION)
...
.PHONY: build
build:
	@go build -mod=mod -o bin/distill main.go
...
format:
	...
	go run github.com/incu6us/goimports-reviser/v3@$(GOIMPORTS_REVISER_VERSION) -project-name github.com/bborbe/distill -format -excludes vendor ./...
